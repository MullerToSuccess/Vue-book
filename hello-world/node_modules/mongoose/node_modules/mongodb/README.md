...
---------------------
Let's create a new **book.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **book.js** file.

```
node book.js
```

You should see the following output after running the **book.js** file.
